...
const projects = [
  {
    id: 1,
    title: "Wiggle: Social Media Platform",
    description:
    " A social media platform with real-time updates, chats and interactive UI.",
    image: "/projects/image.png",
    tags: ["React", "MongoDB", "Node.js", "Socket.io", "TailwindCSS", "Express"],
  ...
  },
  {
    ...
    title: "Campistan",
    description:
      "A Camp finding mate with a focus on user experience and performance.",
    ...
    },
    {
      ...
      description: "Frontend clone of X (Twitter) with real-time features.",  
